...
- __opções:__
	...
	- '-s' altea a data e a hora, como exemplificado abaixo;
...
- definir hora e data com date: 
	...
	- ```# hwclock --systohc```,  ou '-w', para sincronizar o relógio do sistema para o relógio do hardware.
...
### chrony
- chrony é a ferramente que ativa o deamon chronyd, outra forma de implementar o NTP, cuja interface CLI é o chronyc;
- 'chrony tracking' é o comando que exibe ninformações sobre o NTP e a hora do sistema:
...
- 'chronyc sources' retrorna informações sobre servidores NTP usados;
- 'chronyc makestep' realiza a atualização manuaç do NTP com chrony.

### /etc/chrony.conf
- arquivo de configuração do chrony, em que as fontes podem ser adicionadas;
- servidores listados estão comentados com um '!' na frente;
