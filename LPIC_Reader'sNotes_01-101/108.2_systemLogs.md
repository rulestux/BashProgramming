...
- '__/etc/logrotate.conf__' é o arquivo de configuração, cujos comentários apresentam explicações das finalidades das opções globais, entre as quais consta a inclusão dos arquivos de configuração extras em: - '__/etc/logrotate.d__' é o diretório onde se incluem arquivos extras de configuração com as linhas:
