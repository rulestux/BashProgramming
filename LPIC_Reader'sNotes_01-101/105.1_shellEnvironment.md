...
- para incluir usuário entre os 'sudoers':
	- ```# usermod -aG sudo user2``` ou ```# useradd -aG sudo USERNAME ```;
...
- 'env' antecedendo a declaração de uma variável prepara ela para uso exclusivo em um script:
