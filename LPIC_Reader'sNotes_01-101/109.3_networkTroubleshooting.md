...
- sem opções, o comando exibe as interface de rede ativas;
- com o nome de uma interface e um IPv4 e máscara CIDR, permite configurar um IP;
- __opções e subcomandos:__
	...
	- 'mtu' permite ajustar o MTU de uma interface fornecida;
...
- __objetos, opções e subcomandos:__
	...
	- 'link' configura interface de baixo nível, protocolos VLANs, ARP ou MTUs e permite desabilitar uma interface:
		- 'ip link set dev IFACE_NAME down' desativa uma interface; up para ativar;
...
### nc
- 'netcat' permite configurar conexões de teste;
- __opções:__
...
### ss
- assim como o '__netstat__' legado, retorna o status de *listeners* e conexões atuais;
- __opções:__
