...
### getent
- o utilitário retorna entradas de bancos de dados de serviçoes de nome a partir de qualquer fonte configurável pelo '/etc/nsswitch.conf', como com a sintaxe ```$ getent hosts```.
