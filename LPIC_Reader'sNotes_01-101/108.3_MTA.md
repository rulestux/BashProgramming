...
### Sendmail
- serviço MTA que é configurado em '/etc/mail/sendmail.mc';
...
- a sintaxe de troca de emails com nc requer:
	...
	- DATA subject e, pulada uma linha, o corpo do email; o final do corpo se sinaliza com um ponto numa linh separada;
	- QUIT encerra a conexão.
- o destinatário recebe uma sinalização de que tem um email no caminho '__/var/spool/mail/destinatário__';
...
- as mensagens recebidas são listadas com um índice numérico, podendo ser lidas com o comando 'print N', em que 'N' é o número no índice;
...
- exemplo de uso com '-s' para inserção de assunto e hereline para o corpo: ```$ mail -s "Maintenance fail" henry@lab3.campus <<<"The maintenance script failed at `date`"```;
- se nenhum conteúdo é fornecido, o programa aguarda o corpo da mensagem cuja inserção se encerra com 'ctrl+D'.

### /etc/aliases 
- arquivo com aliases úteis para MTAs;
- o comando 'newaliases' deve ser executado sempre que o arquivo for alterado.